...
class TestingRecipesAppFunctionality(unittest.TestCase):
    ...
    def test_restrict_recipe_number_1(self):
        self.assertEqual(restrict_recipe_number(recipe_number=10), 10)

    def test_restrict_recipe_number_2(self):
        self.assertEqual(restrict_recipe_number(recipe_number=100), 100)

    def test_restrict_recipe_number_invalid_1(self):
        self.assertEqual(restrict_recipe_number(recipe_number=0), 1)

    def test_restrict_recipe_number_invalid_2(self):
        self.assertEqual(restrict_recipe_number(recipe_number=-10), 1)

    def test_crestrict_recipe_number_invalid_3(self):
        self.assertEqual(restrict_recipe_number(recipe_number=101), 100)
